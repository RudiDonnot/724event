...
const Page = () => {
  const [updatedLastEvent, updateList] = useState();
  const { data } = useData();
    ...
    <>
      ...
      <footer className="row">
        <div className="col presta">
          ...
          <EventCard
            imageSrc={updatedLastEvent?.cover}
            title={updatedLastEvent?.title}
            date={new Date(updatedLastEvent?.date)}
            small
            label="boom"
          />
        </div>
